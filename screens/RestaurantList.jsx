...
export default function RestaurantList({ navigation }) {
  const [restaurants, setRestaurants] = useState([
    ...
    { id: 3, name: 'Restaurante C', description: 'Descripción del Restaurante C', image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/05/c2/d9/18/hanzo-peruvian-japanese.jpg?w=600&h=-1&s=1' },
  ]);
